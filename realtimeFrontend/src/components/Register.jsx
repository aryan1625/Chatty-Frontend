  ...
  return (
    <div className='bg-[#131324] w-full h-screen overflow-x-hidden'>
      <div className='bg-black/75 w-[60%] mt-32 rounded-xl mx-auto my-auto flex flex-col text-white px-1 py-3'>
        ...
        <div className='mt-5 mx-auto w-[75%] text-center text-sm pb-5 md:mt-16'>ALREADY HAVE AN ACCOUNT? <Link to="/" className='text-indigo-700 cursor-pointer hover:text-indigo-500'>LOGIN</Link></div>
      </div>
      <ToastContainer/>
    </div>
  )
